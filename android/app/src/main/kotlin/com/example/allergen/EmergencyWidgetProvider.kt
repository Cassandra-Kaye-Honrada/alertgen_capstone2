// android/app/src/main/kotlin/com/example/allergen/EmergencyWidgetProvider.kt
...
class EmergencyWidgetProvider : AppWidgetProvider() {
    ...
    private fun updateWidget(
        ...
        try {
            ...
            views.setOnClickPendingIntent(R.id.emergency_widget_container, pendingIntent)
